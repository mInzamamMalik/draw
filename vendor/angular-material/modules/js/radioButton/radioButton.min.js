...
!function (e, t, n) {
    ...
    function i(e, n, i, r) {
        function o(o, a, d, c) {
            ...
            i(a);
            var l = c[0], m = c[1] || e.fakeNgModel();
            l.init(m), o.mouseActive = !1, a.attr({
                role: "radiogroup",
        ...
        function c(n, i) {
            ...
            if (r.count()) {
                ...
                }, a = n[0].querySelector("md-radio-button.md-checked"), d = r[0 > i ? "previous" : "next"](a, o) || r.first();
    ...
    function r(e, t, n) {
        function i(i, o, a, d) {
            function c(e) {
                ...
                d.add(u), a.$observe("value", u), o.on("click", s).on("$destroy", function () {
                    d.remove(u)
                })
            }
