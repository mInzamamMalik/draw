    ...
    function r(e, t, n) {
        function i(i, o, d, a) {
            ...
            function s() {
                ...
                e !== l && (l = e, o.attr("aria-checked", e), e ? (o.addClass(r), a.setActiveDescendant(o.attr("id"))) : o.removeClass(r))
            }
            ...
            var l;
            n(o), u(o, i), a.add(s), d.$observe("value", s), o.on("click", c).on("$destroy", function () {
                a.remove(s)
            })
        }
