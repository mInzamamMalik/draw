...
!function (e, t, n) {
        ...
        return {
            require: ["mdMenuItem", "?ngModel"], priority: 210, compile: function (e, n) {
                ...
                if ("checkbox" == n.type || "radio" == n.type) {
                    ...
                    s.html(r), s.attr("tabindex", "0"), e.html(""), e.append(t.element('<md-icon md-svg-icon="check"></md-icon>')), e.append(s), e[0].classList.add("md-indent"), o("role", "checkbox" == n.type ? "menuitemcheckbox" : "menuitemradio", s), t.forEach(["ng-disabled"], i)
    ...
    o.$inject = ["$scope", "$rootScope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], o.prototype.init = function () {
        ...
        e.on("keydown", this.handleKeyDown), this.parentToolbar = t.getClosest(e, "MD-TOOLBAR"), r.push(this.$rootScope.$on("$mdMenuOpen", function (t, n) {
            ...
            var u = i.getMenus();
            if (-1 != u.indexOf(r[0]) && (e[0].classList.remove("md-open"), r[0].classList.remove("md-open")), e[0].contains(r[0])) {
                for (var a = r[0]; a && -1 == u.indexOf(a);)a = t.getClosest(a, "MD-MENU", !0);
