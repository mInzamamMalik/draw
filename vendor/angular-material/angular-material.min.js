    ...
    !function () {
        ...
        function e(e, n, o, r, i) {
            ...
            return a = {
                translate3d: function (e, t, o, r) {
                    ...
                    if (r) {
                        var l = a.clientRect(r) || a.copyRect(o.bounds), m = a.copyRect(n[0].getBoundingClientRect()), s = a.centerPointFor(m), u = a.centerPointFor(l);
                        c = d({
                            centerX: u.x - s.x,
                            centerY: u.y - s.y,
        ...
        t.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", "$q", "$compile", "$window", "$mdConstant", "$$rAF", "$rootScope", "$$mdAnimate", function (r, i, a, d, c, l, m, s, u, p) {
            ...
            var h = {
                ...
                scrollTop: function (e) {
                    ...
                    var o = e[0] == i[0].body ? i[0].body : n, r = o ? o.scrollTop + o.parentElement.scrollTop : 0;
                ...
                disableScrollAround: function (e, n) {
                    function o(e) {
                        ...
                        e = t.element(e || d)[0];
                        var r = 50, a = t.element('<div class="md-scroll-mask" style="z-index: ' + r + '">  <div class="md-scroll-mask-bar"></div></div>');
                        return e.appendChild(a[0]), a.on("wheel", o), a.on("touchmove", o), i.on("keydown", n), function () {
                            a.off("wheel"), a.off("touchmove"), a[0].parentNode.removeChild(a[0]), i.off("keydown", n), delete h.disableScrollAround._enableScrolling
                        }
                    }

                    function r() {
                        var e = d.parentNode, t = e.getAttribute("style") || "", n = d.getAttribute("style") || "", o = h.scrollTop(d), r = d.clientWidth;
                ...
                throttle: function (e, t) {
                    var n;
                    return function () {
                        var o = this, r = arguments, i = h.now();
                ...
                nextTick: function (e, t) {
                    ...
                    var o = h.nextTick, r = o.timeout, i = o.queue || [];
        ...
        function e(e, n, o, r, i, a) {
            this.compile = function (d) {
                var c = d.templateUrl, l = d.template || "", m = d.controller, s = d.controllerAs, u = t.extend({}, d.resolve || {}), p = t.extend({}, d.locals || {}), f = d.transformTemplate || t.identity, h = d.bindToController;
                return t.forEach(u, function (e, n) {
                    u[n] = t.isString(e) ? o.get(e) : o.invoke(e)
                }), t.extend(u, p), u.$template = c ? n.get(c, {cache: a}).then(function (e) {
                    return e.data
                }) : e.when(l), e.all(u).then(function (e) {
                    var n = f(e.$template), o = d.element || t.element("<div>").html(n.trim()).contents(), a = r(o);
                    return {
        ...
        function a(e, n) {
            ...
            var m = "mousedown touchstart pointerdown", f = "mousemove touchmove pointermove", b = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
        ...
        function e() {
            function e(e) {
                ...
                function i(n, o) {
                    ...
                    var a, l, m = n(), s = {hide: m.hide, cancel: m.cancel, show: r};
                    return a = c.methods || [], l = i(c.optionsFactory, {}), t.forEach(d, function (e, t) {
                        ...
                        var r = i(e.optionsFactory, {}), d = (e.methods || []).concat(a);
                        if (t.extend(r, {$type: n}), t.forEach(d, function (e) {
                ...
                return l.addPreset("build", {methods: ["controller", "controllerAs", "resolve", "template", "templateUrl", "themable", "transformTemplate", "parent"]}), i.$inject = ["$$interimElement", "$injector"], l
            }
            ...
            function o(e, o, r, i, a, d, c, l, m, s) {
                ...
                var p = c.startSymbol(), f = c.endSymbol(), h = "{{" === p && "}}" === f, b = h ? t.identity : u;
                return function () {
                    function c(e) {
                        var t = new p(e), n = E.length ? f.hide() : o.when(!0);
                    ...
                    function s(e) {
                        var t = E.shift();
                        return t ? (t.remove(e || g, !1)["catch"](function (e) {
                        }), t.deferred.promise) : o.when(e)
                    }

                    function u(e) {
                        var t = E.shift();
                        return t ? (t.remove(e || h, !0)["catch"](function (e) {
                        }), t.deferred.promise) : o.when(e)
                    }
                    ...
                    function p(c) {
                        ...
                        var A, T, C = o.when(!0);
                        return c = p(c), A = {options: c, deferred: o.defer(), show: s, remove: u}
                    }

                    var f, h = !1, g = !0, E = [];
                    return f = {show: c, hide: s, cancel: u}
                }
            }
        ...
        function n(e, n, o) {
            function r(r, i, a) {
                ...
                function l(e, t) {
                    E.splice(E.indexOf(e), 1), 0 === E.length && d().css({backgroundColor: ""}), n(function () {
                        e.remove()
                    }, t, !1)
                }

                function m(e) {
                    var t = E.indexOf(e), n = v[t] || {}, o = E.length > 1 ? !1 : $, r = E.length > 1 ? !1 : A;
                ...
                function s(r, l) {
                    function s(e) {
                        ...
                        return E.unshift(n), v.unshift({animating: !0}), f.append(n), e && n.css(e), n
                    }

                    function u(e, t) {
                        var n, o, r, i = f.prop("offsetWidth"), d = f.prop("offsetHeight");
                    ...
                    function p(e, t, n) {
                        ...
                        var r = T.getBoundingClientRect(), i = {
                            backgroundColor: o(y),
                            borderColor: o(y),
                            width: e + "px",
                            height: e + "px"
                    ...
                    var f = d(), b = u(r, l), M = p(b, r, l), $ = s(M), A = E.indexOf($), C = v[A] || {};
                    return h = b, C.animating = !0, o.nextTick(function () {
                        a.dimBackground && f.css({backgroundColor: y}), $.addClass("md-ripple-placed md-ripple-scaled"), $.css(a.outline ? {
                            borderWidth: .5 * b + "px",
                            marginLeft: b * -.5 + "px",
                            marginTop: b * -.5 + "px"
                        } : {left: "50%", top: "50%"}), m($), n(function () {
                            C.animating = !1, m($)
                        }, a.outline ? 450 : 225, !1)
                    }), $
                }
                ...
                function f() {
                    ...
                    var t = T.parentNode, n = t && t.parentNode, o = n && n.parentNode;
                ...
                var h, b = i.controller("mdInkRipple") || {}, g = 0, E = [], v = [], M = i.attr("md-highlight"), $ = !1, A = !1, T = i[0], C = i.attr("md-ripple-size"), y = c(i.attr("md-ink-ripple")) || c(a.colorElement.length && e.getComputedStyle(a.colorElement[0]).color || "rgb(0, 0, 0)");
                switch (C) {
                    case"full":
                        a.fullRipple = !0;
                        break;
            ...
            function c(e) {
                function n(e) {
                    if (e = 0 === arguments.length ? !0 : !!e, e !== o.isDark) {
                        ...
                        var n = o.isDark ? T : A, r = o.isDark ? A : T;
        ...
        function a(e) {
            ...
            if (r && 0 !== a.length) {
                ...
                M.forEach(function (e) {
                    ...
                    for (var t, n = (e.match(p), 0); t = M[n]; n++)if (e.indexOf(".md-" + t) > -1)return d[t] += e;
        ...
        }, T = {background: {"default": "800", "hue-1": "300", "hue-2": "600", "hue-3": "900"}};
        M.forEach(function (e) {
        ...
        function n(e) {
            function n(e, n, i, a, d, c, l) {
                ...
                function u(e, t) {
                    ...
                    var s = l.register(t, "drag", {horizontal: !1});
        ...
        function e(e, n) {
            return {
                restrict: "E", link: function (o, r, i) {
                    n(r), e(function () {
                        function e() {
        ...
        function n(e) {
            ...
            function o(e, n, o, r, i, a, d, c) {
                ...
                function s(e, n) {
                    var r = {element: null, bounds: null, focus: t.noop};
                ...
                function b(e, t) {
                    var n = "fixed" == d.getComputedStyle(a[0].body).position, r = t.backdrop ? d.getComputedStyle(t.backdrop[0]) : null, i = r ? Math.ceil(Math.abs(parseInt(r.height, 10))) : 0;
                    return e.css({top: (n ? o.scrollTop(t.parent) / 2 : 0) + "px", height: i ? i + "px" : "100%"}), e
                }
            ...
            function e() {
                return {
                    restrict: "E", require: ["^?mdFabSpeedDial", "^?mdFabToolbar"], compile: function (e, n) {
                        var o = e.children();
                        return o.attr("ng-repeat") ? o.addClass("md-fab-action-item") : o.wrap('<div class="md-fab-action-item">'), function (e, n, o, r) {
                            var i = r[0] || r[1];
        ...
        !function () {
            ...
            function o() {
                function n(n, o, r) {
                    ...
                    if (c && d) {
                        var s = e.getComputedStyle(c).getPropertyValue("background-color"), u = i.offsetWidth, p = (i.offsetHeight, 2 * u);
        ...
        function e(e, o, r, i) {
            function a(n, a, d, c) {
                ...
                function f(e, t, n, o, r, i, a) {
                    ...
                    switch (i) {
                        ...
                        case"ratio":
                            ...
                            break;
                        case"fit":
                            var p = (o - 1) / o, s = 1 / o * 100, u = x({share: s, gutterShare: p, gutter: r});
                ...
                var T = t.bind(c, c.invalidateLayout), C = l();
                n.$on("$destroy", m);
                var y, w = e.startSymbol(), k = e.endSymbol(), x = e(p("share") + "% - (" + p("gutter") + " * " + p("gutterShare") + ")"), N = e("calc((" + p("unit") + " + " + p("gutter") + ") * " + p("offset") + ")"), _ = e("calc((" + p("unit") + ") * " + p("span") + " + (" + p("span") + " - 1) * " + p("gutter") + ")")
            }

            return {
                restrict: "E", controller: n,
                scope: {mdOnLayout: "&"}, link: a
            }
        }
            ...
            function r(r, i, a, d) {
                ...
                function m() {
                    ...
                    if (!t.isDefined(i.attr("md-no-autogrow"))) {
                        var l = i[0], m = s.element[0], p = 0 / 0, f = null;
                ...
                var s = d[0], u = d[1] || e.fakeNgModel(), p = t.isDefined(a.readonly);
                if (s) {
            ...
            return {
                restrict: "E", controller: "MdListController", compile: function (i, a) {
                    ...
                    if (i[0].setAttribute("role", "listitem"), a.ngClick)c("button"); else {
                        for (var f, h = 0; f = r[h]; ++h)if (u = i[0].querySelector(f)) {
                            s = !0;
                            break
                        }
            ...
            function r(o, r, a, d, c, l) {
                function m(e, n, i) {
                    ...
                    function p() {
                        ...
                        return o || (o = i.menuContentEl[0].firstElementChild.firstElementChild), o.focus(), function () {
                    ...
                    return l(i), d.inherit(i.menuContentEl, i.target), m(), i.disableParentScroll && (i.restoreScroll = a.disableScrollAround(i.element)), i.backdrop && (d.inherit(i.backdrop, i.parent), i.parent.append(i.backdrop)), u(), h.waitTransitionEnd(n, {timeout: 370})["finally"](function (e) {
                ...
                function s(e, t, n, o) {
                    for (var r = a.getClosest(e.target, "MD-MENU-ITEM"), i = a.nodesToArray(t[0].children), d = i.indexOf(r), c = d + o; c >= 0 && c < i.length; c += o) {
                        var l = i[c].firstElementChild || i[c], m = u(l);
                        if (m)break
                    }
                }
                ...
                function p(e, o, i) {
                    return i.isRemoved = !0, o.addClass("md-leave"), i.cleanupInteraction(), t.element(r).off("resize", i.resizeFn), t.element(r).off("orientationchange", i.resizeFn), i.resizeFn = n, h.waitTransitionEnd(o, {timeout: 370})["finally"](function () {
                ...
                function f(t, n) {
                    ...
                    function r() {
                        for (var t = 0; t < s.children.length; ++t)if ("none" != e.getComputedStyle(s.children[t]).display)return s.children[t]
                    }

                    if (!n.isRemoved) {
                        var a, d, l, m = t[0], s = t[0].firstElementChild, u = s.getBoundingClientRect(), p = n.parent[0], f = p.getBoundingClientRect(), h = n.target[0].querySelector("[md-menu-origin]") || n.target[0], b = h.getBoundingClientRect(), g = {
                            left: f.left + i,
        ...
        function e(e, o, r, i, a, d, c) {
            function l(a, l) {
                ...
                if (m.append('<span class="md-select-icon" aria-hidden="true"></span>'), m.addClass("md-select-value"), m[0].hasAttribute("id") || m.attr("id", "select_value_label_" + o.nextUid()), a.find("md-content").length || a.append(t.element("<md-content>").append(a.contents())), l.mdOnOpen && a.find("md-content").prepend(t.element("<md-progress-circular>").attr("md-mode", "indeterminate").attr("ng-hide", "$$loadingAsyncDone").wrap("<div>").parent()), l.name) {
                    ...
                    s.attr({name: "." + l.name, "ng-model": l.ngModel, "aria-hidden": "true", tabindex: "-1"});
                ...
                return a.empty().append(m), l.tabindex = l.tabindex || "0", function (a, l, m, s) {
                    ...
                    var v, M, $ = s[0], A = s[1], T = s[2], C = s[3], y = l.find("md-select-value"), w = t.isDefined(m.readonly);
                    if ($) {
                    ...
                    var x, N, _;
                    if (b(), r(l), m.name && C) {
                        var H = l.parent()[0].querySelector('select[name=".' + m.name + '"]'), S = t.element(H).controller();
                        S && C.$removeControl(S)
                    }
                    var I = T.$render;
                    T.$render = function () {
                    ...
                    var D = {role: "combobox", "aria-expanded": "false"};
        ...
        function a(e) {
            function o(e, o, a, c, l, m, s, u) {
                function p(r, i, d) {
                    ...
                    function p() {
                        function t(e) {
                            ...
                            var t, o = c.nodesToArray(f), r = o.indexOf(d.focusedNode);
                    ...
                    }), d.isRemoved ? s.reject(!0) : b.waitTransitionEnd(d.selectEl, {timeout: 470})["finally"](function () {
                        p()
                    })
                }
                ...
                function f(e, o, r) {
                    ...
                    return i && i.setLabelText(r.selectEl.controller("mdSelectMenu").selectedLabels()), r.backdrop && r.backdrop.remove(), b.waitTransitionEnd(o, {timeout: 370})["finally"](function () {
                ...
                function h(e, t, n) {
                    var l, s = t[0], u = n.target[0].firstElementChild, p = n.parent[0], f = n.selectEl[0], h = n.contentEl[0], b = p.getBoundingClientRect(), g = u.getBoundingClientRect(), E = !1, v = {
                        left: b.left + d,
                        top: d,
                        bottom: b.height - d,
                    ...
                    }, $ = b.width - 2 * d, A = h.scrollHeight > h.offsetHeight, T = f.querySelector("md-option[selected]"), C = f.getElementsByTagName("md-option"), y = f.getElementsByTagName("md-optgroup");
                    ...
                    var k = f.getBoundingClientRect(), x = i(l);
                    if (l) {
                ...
                return {parent: "body", onShow: p, onRemove: f, hasBackdrop: !0, disableParentScroll: !0, themable: !0}
            }
        ...
        function r(e, o, r, i, a, d, c, l, m, s) {
            function u(d, u, p, f) {
                ...
                function b(e) {
                    var t = u.parent(), n = f.focusElement();
                ...
                var $, A = null, T = m.when(!0), C = c(p.mdIsLockedOpen), y = function () {
                    return C(d.$parent, {
                        $media: function (t) {
        ...
        function e(e, n, o, r, i, a, d, c, l) {
            function m(e, t) {
                return e.attr({tabIndex: 0, role: "slider"}), o.expect(e, "aria-label"), s
            }
            ...
            function s(o, m, s, u) {
                ...
                var P = s.ngDisabled && c(s.ngDisabled), F = P ? function () {
                    return P(o.$parent)
                } : t.noop, B = t.element(m[0].querySelector(".md-thumb")), z = t.element(m[0].querySelector(".md-thumb-text")), j = B.parent(), q = t.element(m[0].querySelector(".md-track-container")), V = t.element(m[0].querySelector(".md-track-fill")), U = t.element(m[0].querySelector(".md-track-ticks")), Y = r.throttle(v, 5e3);
                ...
                var G, X, Q, Z, J, ee = {};
                v();
                var te = !1, ne = t.isDefined(s.mdDiscrete)
            }
        ...
        function e(e, o, r, i, a) {
            function d(e) {
                function t(e, t) {
                    ...
                    return h.items.push(n), p.parent().prepend(n.clone), f(), function () {
                ...
                function r() {
                    ...
                    for (var e, t = p.prop("scrollTop"), n = h.items.length - 1; n >= 0; n--)if (t > h.items[n].top) {
                        e = h.items[n];
                        break
                    }
                    m(e)
                ...
                var p = e.$element, f = i.throttle(r);
            ...
            return {
                restrict: "E", controller: t.noop, link: function (d, c, l) {
                    function m() {
                        ...
                        var s, u, p = 0, f = 0, h = l.mdShrinkSpeedFactor || .5, b = e.throttle(m), g = o.debounce(r, 5e3);
        ...
        function e(e, n, o, r, i, a, d, c, l) {
            function m(m, p, f) {
                ...
                function w() {
                    ...
                    var o = i.offsetRect(p, S), r = i.offsetRect(k, S), a = n(_);
                ...
                a(p);
                var k = v(), x = t.element(p[0].getElementsByClassName("md-background")[0]), N = t.element(p[0].getElementsByClassName("md-content")[0]), _ = f.mdDirection, H = M(), S = t.element(H || document.body), I = o.throttle(function () {
                    m.visible && w()
                });
                h(), E(), A(), b(), g()
            }
        ...
        o.$inject = ["$$rAF", "$scope", "$element", "$attrs"], o.prototype.register = function (e) {
            ...
            if (a > e)this.sizer.style[t] = e + "px"; else {
                this.sizer.innerHTML = "", this.sizer.style[t] = "auto", this.sizer.style[n] = "auto";
                var o = Math.floor(e / a), r = document.createElement("div");
            ...
            if (e !== this.scrollOffset) {
                ...
                if (t) {
                    var n = Math.max(0, Math.floor(e / t) - d), o = this.isHorizontal() ? "translateX(" : "translateY(";
        ...
        function e(e, o, a, d, c, l, m, s, u, p) {
            ...
            function h() {
                function e() {
                    var e = ne.ul.getBoundingClientRect(), n = {};
                    e.right > o.right - i && (n.left = t.right - e.width + "px"), ne.$.ul.css(n)
                }

                if (!ne)return a.nextTick(h, !1);
                var t = ne.wrap.getBoundingClientRect(), n = ne.snap.getBoundingClientRect(), o = ne.root.getBoundingClientRect(), d = n.bottom - o.top, c = o.bottom - n.top, l = t.left - o.left, m = t.width, s = {
                    left: l + "px",
                    minWidth: m + "px",
            ...
            function Y() {
                ...
                t.initCustomEvent("input", !0, !0, {value: e.searchText}), ne.input.dispatchEvent(t), ne.input.focus()
            }
            ...
            function W(n) {
                ...
                var r = e.$parent.$eval(te), i = n.toLowerCase();
            ...
            function X() {
                if (ne.li[J.index]) {
                    var e = ne.li[J.index], t = e.offsetTop, n = t + e.offsetHeight, o = ne.ul.clientHeight;
            ...
            function Z() {
                var t = e.searchText, n = J.matches, o = n[0];
                1 === n.length && P(o).then(function (e) {
                    t == e && U(0)
                })
            }

            var J = this, ee = e.itemsExpr.split(/ in /i), te = ee[1], ne = null, oe = {}, re = !1, ie = [], ae = !1, de = 0;
        ...
        function e(e, n, o) {
            ...
            function d() {
                if (null !== m.term && null !== m.template) {
                    var r = o(m.template)(e), i = t.element("<div>").text(r).html(), a = n.attr("md-highlight-flags") || "", d = l(m.term, a), c = i.replace(d, '<span class="highlight">$&</span>');
                    n.html(c)
                }
            }
        ...
        function e() {
            return {
                terminal: !0, scope: !1, controller: "MdHighlightCtrl", compile: function (e, t) {
                    var n = e.html();
        ...
        function e(e) {
            ...
            return {restrict: "A", terminal: !0, link: t, scope: !1}
        }
        ...
        function e(e, t, a, d, c) {
            function l(n, l) {
                ...
                var u = m("md-chips>*[md-chip-remove]") || i, p = m("md-chips>md-chip-template") || r, f = m("md-chips>md-autocomplete") || m("md-chips>input") || o, h = s.find("md-chip");
        ...
        function e(e, n, o, r, i, a, d, c, l, m) {
            ...
            function u() {
                var e = c.$mdTabsTemplate, n = t.element(de.data);
            ...
            function _() {
                var e, t, n = de.canvas.clientWidth, o = n + ie.offsetLeft;
            ...
            function K(e, t) {
                var n, o = t ? "focusIndex" : "selectedIndex", r = ie[o];
            ...
            function X(e) {
                if (null == e && (e = ie.focusIndex), de.tabs[e] && !ie.shouldCenterTabs) {
                    var t = de.tabs[e], n = t.offsetLeft, o = t.offsetWidth + n;
            ...
            function ee() {
                ...
                var e = de.contents[ie.selectedIndex], t = e ? e.offsetHeight : 0, o = de.wrapper.offsetHeight, r = t + o, i = n.prop("clientHeight");
                i !== r && (ae = !0, d.animate(n, {height: i + "px"}, {height: r + "px"}).then(function () {
                    n.css("height", ""), ae = !1
                }))
            }
            ...
            function te() {
                if (de.tabs[ie.selectedIndex]) {
                    ...
                    var e, o = ie.selectedIndex, r = de.paging.offsetWidth, i = de.tabs[o], d = i.offsetLeft, c = r - d - i.offsetWidth;
            ...
            function ne() {
                var e = ie.selectedIndex, n = ie.lastSelectedIndex, o = t.element(de.inkBar);
                t.isNumber(n) && o.toggleClass("md-left", n > e).toggleClass("md-right", e > n)
            }

            function oe(e) {
                if (!de.tabs.length || !ie.shouldPaginate)return 0;
                var t = de.tabs[de.tabs.length - 1], n = t.offsetLeft + t.offsetWidth;
                return e = Math.max(0, e), e = Math.min(n - de.canvas.clientWidth, e)
            }

            function re(e, n) {
                var o = {colorElement: t.element(de.inkBar)};
                i.attach(e, n, o)
            }

            var ie = this, ae = !1, de = L(), ce = [], le = !1, me = !1;
        ...
        function e(e, t) {
            ...
            return {
                restrict: "A",
                link: n,
                scope: {template: "=mdTemplate", connected: "=?mdConnectedIf", compileScope: "=mdScope"},
                require: "^?mdTabs"
            }
        }
