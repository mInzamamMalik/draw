!function (a, b, c) {
    ...
    function h(a, c, d, e, f, g, h, i, j) {
        function k(c, d) {
            ...
            if (d.controller ? f = m(d, h, {
                    $element: i,
                    $scope: h
                }) : b.extend(h, d.scope), d.disableScroll && l(i), u.prepend(j).append(i.addClass("md-whiteframe-1dp")), q(i, d.targetEvent.currentTarget), d.focusOnOpen) {
                var k = e.findFocusTarget(i);
                k && k.focus()
            }
        ...
        function l(a) {
            var b = e.disableScrollAround(a, u);
        ...
        var s = 27, t = !1, u = b.element(d.prop("body")), v = {
        ...
        return this.show = function (a) {
            if (t)return f.reject();
            if (t = !0, a = b.extend({}, v, a), !a.targetEvent)return o("options.targetEvent is required to align the dialog with the table cell.");
    ...
    function j(a) {
        ...
        function e(c, d, e, f) {
            ...
            c.allSelected = function () {
                var a = f.getBodyRows();
                return a.length && a.map(i).every(function (a) {
